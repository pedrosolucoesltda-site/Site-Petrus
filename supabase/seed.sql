...
insert into licitacoes
  ...
  ('b0000000-0000-4000-8000-000000000001', 'Prefeitura de Niterói',    'Pavimentação — Bairro Fonseca',   'PMN 024/2026',  'concorrencia_eletronica', 'Concorrência Eletrônica 024/2026', 'RJ', 3200000, null,    null, current_date + 3,  ((current_date + 3) + time '09:00') at time zone 'America/Sao_Paulo', 'aberta',                null),
  ('b0000000-0000-4000-8000-000000000002', 'DER-RJ',                   'Recuperação de via — RJ-104',      'DER 104/2026',  'concorrencia_eletronica', 'Concorrência Eletrônica 104/2026', 'RJ', 5800000, 4640000, null, current_date + 11, (((current_date + 11) + time '09:00') at time zone 'America/Sao_Paulo', 'em_proposta',           null),
  ('b0000000-0000-4000-8000-000000000003', 'Governo do Estado',        'Reforma escolar — Zona Norte',     'GOV 1003/2026', 'concorrencia_presencial', 'Concorrência Presencial 1.003/2026','RJ', 2100000, null,    null, current_date + 19, (((current_date + 19) + time '09:00') at time zone 'America/Sao_Paulo', 'aberta',                null),
  ('b0000000-0000-4000-8000-000000000004', 'Prefeitura de São Gonçalo','Drenagem — Centro',                 'PMSG 011/2026', 'concorrencia_eletronica', 'Concorrência Eletrônica 011/2026', 'RJ', 4000000, 3720000, null, current_date + 8,  ((current_date + 8) + time '09:00') at time zone 'America/Sao_Paulo', 'selecao_fornecedores',  null),
  ('b0000000-0000-4000-8000-000000000005', 'CEDAE',                    'Manutenção de rede — Zona Sul',     'CEDAE 037/2026','pregao_eletronico',       'Pregão Eletrônico 037/2026',       'RJ', 1600000, 1488000, 2,    current_date - 1,  ((current_date - 1) + time '09:00') at time zone 'America/Sao_Paulo', 'aguardando_julgamento', null),
  ('b0000000-0000-4000-8000-000000000006', 'Prefeitura de Itaboraí',   'Construção de creche municipal',    'PMI 002/2026',  'concorrencia_eletronica', 'Concorrência Eletrônica 002/2026', 'RJ', 2900000, 2712000, 1,    current_date - 10, (((current_date - 10) + time '09:00') at time zone 'America/Sao_Paulo', 'resultado',             'vencedor')
on conflict (id) do nothing;
